/*
 Votre programme doit sortir une expression pour effectuer un developpement d'une autre expression donnEe et donner sa valeur a la fin | ex: (-a+b)(c+d) -> -a*c + -a*d + b*c + b*d 
*/
